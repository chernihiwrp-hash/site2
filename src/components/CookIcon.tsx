// =====================================================================
// CookIcon.tsx — універсальний рендер іконки (emoji АБО URL картинки)
// Якщо значення схоже на URL (http://, https://, /, data:image, .png/.jpg/.webp/.svg/.gif)
// — рендерить <img>, інакше — emoji/текст.
// =====================================================================
