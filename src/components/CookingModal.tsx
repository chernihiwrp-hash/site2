...
import { isImageSrc } from "./CookIcon"; // Імпортуємо виправлену функцію
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="glass-card w-full max-w-[360px] rounded-[45px] p-10 relative z-10 flex flex-col items-center">
        {!done ? (
          <>
            <div className="text-white/40 text-[11px] uppercase tracking-[0.4em] font-bold mb-10">Приготування...</div>
            ...
            <h3 className="text-white text-2xl font-bold tracking-tight mb-8">{dishName}</h3>
            <div className="w-full">
              <div className="h-4 w-full bg-black/30 rounded-full overflow-hidden border border-white/10 p-[3px]">
                <div className="h-full bg-gradient-to-r from-lime-400 via-lime-300 to-emerald-400 rounded-full transition-all duration-150 ease-out shadow-[0_0_15px_rgba(163,230,53,0.6)]"
          ...
          <div className="text-center w-full">
            ...
            <p className="text-white/40 text-sm mb-10 px-4">
              {success ? `Ви майстерно приготували "${dishName}"` : `Щось пішло не так, спробуйте ще раз.`}
            </p>
            <div className="flex flex-col gap-4 w-full">
              ...
              <button onClick={onClose}
                ...
                style={{
                  background: success ? "linear-gradient(135deg, #bef264, #84cc16)" : "linear-gradient(135deg, #f43f5e, #e11d48)",
                  boxShadow: success ? "0 15px 30px -5px rgba(132, 204, 22, 0.4)" : "0 15px 30px -5px rgba(225, 29, 72, 0.4)",
